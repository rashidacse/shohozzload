...
class Transaction extends CI_Controller {
    ...
    public function get_transaction_list() {
        ...
        if (file_get_contents("php://input") != null) {
            ...
            $response['total_amount'] = $transction_list_array['total_amount'];
        ...
        $service_list = array();
        $service_all = array(
            "id" => S_SELECT_ALL_SERVICES_TRANSACTIONS,
            "title" => "All"
        );
        ...
        $this->data['total_amount'] = $transction_list_array['total_amount'];
