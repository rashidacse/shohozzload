...
//        return rand(1, 99);
    ...
    /*
     * This method will return content of bkash service list dropdown at bkash transaction
     * @param $service_id_list, service id list of bkash feature
     * @author nazmul hasan on 23 november 2016
     */
    public function get_bkash_service_list($service_id_list)
    {
        $service_list = array();
        foreach($service_id_list as $service_id)
        {
            ...
            {
                $service_list[] = array(
                    'id' => SERVICE_TYPE_ID_BKASH_CASHIN,
                    'title' => 'Cash In'
                );
            }
            ...
            {
                $service_list[] = array(
                    'id' => SERVICE_TYPE_ID_BKASH_CASHOUT,
                    'title' => 'Cash Out'
                );
            }
        }
    ...
    /*
     * This method will return topup type list for topup transaction page
     * @author nazmul hasan on 27th november 2016
     */
    public function get_topup_types()
    {
        return array(
            array(
                'id' => TRANSACTION_TYPE_ID_PREPAID,
                'title' => 'Prepaid'
            ),
            array(
                'id' => TRANSACTION_TYPE_ID_POSTPAID,
                'title' => 'Postpaid'
            )
        );
    }
