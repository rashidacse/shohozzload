...
<div class="mypage" ng-controller="transctionController" ng-init="initTransactionReceiveHistory('<?php echo htmlspecialchars(json_encode($transction_status_list)) ?>', '<?php echo $user_id?>')"> 
    <ng-form>
