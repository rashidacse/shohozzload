            ...
            <div class="row">
                <div class ="col-md-8 margin-top-bottom">
                    ...
                    <div class="row form-group">
                        ...
                        <div class ="col-md-6">
                            <select  for="status_type" id="type"  ng-model="transactionInfo.status_id" class="form-control control-label requiredField" ng-init="setTransactionStatusList('<?php echo htmlspecialchars(json_encode($transaction_status_list)); ?>')">
