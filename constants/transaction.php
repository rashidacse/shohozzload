...
define("TRANSACTION_BALANCE_CHECK_USER_BALANCE",             1);

define("TRANSACTION_TYPE_ID_PREPAID",                        1);
define("TRANSACTION_TYPE_ID_POSTPAID",                       2);
define("TRANSACTION_TYPE_ID_CASHIN",                         3);
define("TRANSACTION_TYPE_ID_CASHOUT",                        4);
