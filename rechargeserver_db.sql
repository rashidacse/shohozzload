...
(2, '', 'superadmin', '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4', '9462e8eee0', 'super@admin.com',  100000, '', NULL, NULL, NULL, 1268889823, 1373438882, 1, 'Super', 'admin', 'SUPER_ADMIN', '0','1234xyz', 'super admin message'),
(1, '', 'administrator', '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4', '9462e8eee0', 'admin@admin.com',  100000, '', NULL, NULL, NULL, 1268889823, 1373438882, 1, 'Admin', 'istrator', 'ADMIN', '0', '1234xyz',' admin test message');
...
CREATE TABLE IF NOT EXISTS `user_transactions` (
  ...
  `operator_type_id` int(11) unsigned  DEFAULT 5,
  `sender_cell_no` varchar(100),
  `cell_no` varchar(200),
  `description` varchar(200),
  `amount` double DEFAULT 0,
  `cost` double DEFAULT 0,
  `last_balance` double DEFAULT 0,
  `status_id` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `packages` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_packages_operators_idx` (`operator_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1; 
ALTER TABLE `packages`
  ADD CONSTRAINT `fk_packages_operators1` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
