angular.module('controller.Reseller', ['services.Reseller']).
        controller('resellerController', function ($scope, resellerService) {
            ...
            $scope.setResellerList = function (resellerList, collectionCounter) {
                $scope.resellerList = JSON.parse(resellerList);
                 setCollectionLength(collectionCounter);
            }
            $scope.getResellerByPagination = function (num, userId) {
              var offset = getOffset(num);
                resellerService.getResellerByPagination(offset, userId).
